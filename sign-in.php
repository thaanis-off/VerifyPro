...
<body>
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            ...
                            <a href="#"
                                class="rounded-md hover:bg-gray-400  hover:text-white px-3 py-2 text-sm font-medium text-gray-600"
  ...
  ```
-->
    <div class="mx-auto max-w-md px-2 sm:px-6 lg:px-8 mt-10">
        <h2 class="mt-10 mb-6 text-xl font-semibold text-gray-900  sm:text-2xl">Sign in</h2>
        <!-- <div id="img-view"
        ...
        <form>
            ...
            <button type="submit"
                class="flex  text-white bg-zinc-900  focus:ring-2 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Sign in</button>
            <!-- <div>
                <button type="submit"
    ...
    <!-- footer start -->
    <footer class="bg-zinc-100 rounded-lg shadow m-4 mt-48 dark:bg-zinc-100 ">
