...
<body>
    ...
    <div class="mx-auto max-w-2xl px-2 sm:px-6 lg:px-8 mt-10">
        ...
        <form action="process-signup.php" method="post" id="signup" enctype="multipart/form-data" novalidate>
            ...
            <button type="submit"
                class="mb-10 text-gray-900 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2">
                Sign Up</button>
